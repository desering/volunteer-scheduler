...
export const DateTime = ({ className, startDate, endDate }: EventButtonDateProps & BoxProps) => {
  return (
    <panda.p className={className}>
      {format(startDate, 'iiii dd MMMM')}, {format(startDate, 'HH:mm')} - {format(endDate, 'HH:mm')}
    </panda.p>
  )
}
