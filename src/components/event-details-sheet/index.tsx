...
import { Alert } from "../../../packages/astro/src/components/ui/alert";
import { Badge } from "../../../packages/astro/src/components/ui/badge";
...
import { RadioButtonGroup } from "../../../packages/astro/src/components/ui/radio-button-group";
import { Sheet } from "../../../packages/astro/src/components/ui/sheet";
              ...
              <Sheet.Footer justifyContent="center">
                <Switch>
                  <Match when={!props.user}>
                    <HStack>
                      Want to help out?
                      <a class={button({})} href="/src/app/(scheduler)/auth/login">
                        Sign in
                      </a>
                      or
                      <a class={button({})} href="/src/app/(scheduler)/auth/register">
                        Register
                      </a>
                    </HStack>
                  </Match>
